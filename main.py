...
def register(payload: RegisterRequest):
    ...
    db["authuser"].insert_one(user_doc)

    token = create_access_token({"sub": email, "name": payload.name})
    return TokenResponse(access_token=token, name=payload.name, email=email)
